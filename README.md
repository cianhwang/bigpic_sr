...
python test.py --weights-file outputs/edsr_test/1000x16,20xjinc --image-file /media/qian/7f6908d4-b97f-4a1e-ba90-d502c5308801/DIV2K_valid_HR/0823.png --output-path test/edsr_test --model EDSR --f_num 16,20 --n_photon 1000 --kernel jinc --num-channels 2
